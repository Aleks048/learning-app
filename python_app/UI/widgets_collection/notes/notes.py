...
class AddNotesNote_ETR(ww.currUIImpl.TextEntry):
    def __init__(self, patentWidget, prefix):
        name = "_getNotesNewNoteText_ETR"
        defaultText = "New notes note text"  + " / \"solution:\" prefix to add solution"
        renderData = {
...
class Notes_BOX(ww.currUIImpl.ScrollableBox,
    ...
    def __init__(self, parentWidget, prefix, windth = 730, height = 500):
        data = {
